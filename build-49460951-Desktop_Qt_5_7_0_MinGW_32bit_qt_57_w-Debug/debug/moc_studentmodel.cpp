...
#include "../../49460951/studentmodel.h"
...
const QMetaObject StudentModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_StudentModel.data,
      qt_meta_data_StudentModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StudentModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StudentModel.stringdata0))
        return static_cast<void*>(const_cast< StudentModel*>(this));
